-- Maioria da votacao proporcional ao numero de participantes.
-- Antes: 4 votos "sim" aprovavam qualquer votacao (valor fixo).
-- Agora: aprova com metade + 1 dos participantes elegiveis no momento em que
-- a votacao foi aberta (9 participantes -> 5 votos sim; 10 -> 6).
